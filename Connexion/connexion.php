...
<div class="left">
    ...
    <div class="container-left">
        ...
        <p>
            ...
            <input type="password" name="mdp" id="mdp"  required class="input" style="margin-bottom:10px;"><br><br>
            ...
            <a href="connexion_admin.php" id="lien2">Je suis admin</a><br><br>
            <a href="mot_passe_oublié.php">Mot de passe oublié</div>      
        </p>  
</div>
